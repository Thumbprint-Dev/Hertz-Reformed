              ...
              '<div class="hz-hd-bar">',
                ...
                '<nav class="hz-hd-nav" id="hz-hd-nav" aria-label="Main" ng-class="{\'is-open\': hdMenuOpen}">',
                  ...
                  // typing the path.
                      ...
                      '</li>',
                      // Saved orders, for whoever may save one (see orderHistoryView.html):
                      // not allocation employees, whose reorder would skip the cart gate.
                      '<li ng-show="user.Type == \'Customer\' && !user.Permissions.contains(\'HidePricing\')">',
                        '<a href="favoriteorders">{{\'Favorites\' | r | xlat}}</a>',
                      '</li>',
