...
function imagelightboxtemplate () {
    return [
        ...
        '<a class="btn btn-xs btn-default" ng-click="Lightbox.nextImage()" style="border-bottom-right-radius: 4px;border-top-right-radius: 4px">Next <i class="fa fa-chevron-right"></i></a>',
        '<a class="btn btn-xs btn-default pull-right" aria-hidden="true" ng-click="$dismiss()" style="border-bottom-left-radius: 4px;border-top-left-radius: 4px;">Close <i class="fa fa-times"></i></a>',
        '</div>',
        '</div>',
