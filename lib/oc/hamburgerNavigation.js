...
function hamburgernavigation() {
    ...
    function template() {
        return [
            ...
            '</li>',
            //uniform returns
            '<li ng-show="hertzChampionUser || dollarChampionUser || thriftyChampionUser">',
            '<a href="https://thumbprint.com/hertz/UniformReturn" target="_blank">',
            '<i class="fa fa-undo"></i>',
            '<span>{{\'Uniform Returns\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //faq (champion)
            '<li ng-class="{\'active\': isActive([\'faq\'])}" ng-show="hertzChampionUser || dollarChampionUser || thriftyChampionUser">',
            '<a ng-click="retarget(\'faq\')">',
            '<i class="fa fa-question-circle"></i>',
            '<span>{{\'FAQ\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //faq (all)
            '<li ng-class="{\'active\': isActive([\'allofaq\'])}" ng-show="hertzUser || dollarUser || thriftyUser">',
            '<a ng-click="retarget(\'allofaq\')">',
            '<i class="fa fa-question-circle"></i>',
            '<span>{{\'FAQ\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            ...
            //insights
            '<li ng-show="dashUser">',
            '<a href="https://insights.thumbprint.com/open-view/2093611000064627062/a92a916fa5c66604abe402721d22cb5a" target="_blank">',
            '<i class="fa fa-dashboard"></i>',
            '<span>{{\'Dashboard\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //cart
            ...
            '</li>',
            //promo
            '<li ng-class="{\'active\': isActive([\'tth_allpromo\'])}" ng-show="adminUser || purchaserUser">',
            '<a ng-click="retarget(\'catalog/tth_allpromo\')">',
            '<i class="fa fa-bullhorn"></i>',
            '<span>{{\'Promo\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //marketing
            '<li ng-class="{\'active\': isActive([\'tts_marketing\'])}" ng-show="adminUser || user.Username === \'ThomsponThrift_ncrosby@thompsonthrift.com\' || user.Username === \'ThomsponThrift_kwhitaker@thompsonthrift.com\' || user.Username === \'ThomsponThrift_mhettinger@thompsonthrift.com\'">',
            '<a ng-click="retarget(\'catalog/tts_marketing\')">',
            '<i class="fa fa-bullhorn"></i>',
            '<span>{{\'Marketing\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //uc insights
            '<li ng-show="hertzChampionUser || dollarChampionUser || thriftyChampionUser">',
            '<a ng-click="retarget(\'uniforminsights\')">',
            '<i class="fa fa-bar-chart-o"></i>',
            '<span>{{\'UC Insights\' | r | xlat}}</span>',
            '</a>',
            '</li>',
            //insights (insightsUser)
            '<li ng-show="insightsUser">',
            '<a ng-click="retarget(\'insights\')">',
            '<i class="fa fa-bar-chart-o"></i>',
            '<span>{{\'Insights\' | r | xlat}}</span>',
            '</a>',
            '</li>',
