four51.app.factory('Product', ['$resource', '$451', 'Security', 'User', function($resource, $451, Security, User) {
	...
	// NOTE: The cache was not working properly and was always returning all products regardless of requested limits, so disable it for now.
    // var _search = function(categoryInteropID, searchTerm, relatedProductsGroupID, success, page, pagesize) {
	// 	console.log('>>> Product _search', categoryInteropID, page, pagesize);
	...
	// 			console.log('451 products', criteria, products)
	// 			debugger;
